# Author    : Kiran raj R.
# Date      : 18/08/2025
# Question  : Learn List in Python
#----------------------------------------------------------
# Ordered           : They maintain the order of elements.
# Mutable           : Items can be changed after creation.
# Allow duplicates  : They can contain duplicate values.
# Mixed data types  : They can hold mixed data types.
#----------------------------------------------------------
...
print("# Indexing, access elements using index")
print(f"First number {nums[0]}")
print(f"Last number {nums[-1]}")


# Create list using constructor
print("#Creating a list using constructor 'list()'")
...
# Index
print("# To get the index of the element use index()")
...
# Count
print("# To get count of an elements use count()")
...
# Sort
print("# sort() method sorts the elements of a list.")
...
# Adding element
print("# Adding elements at the end using append()")
nums.append(23)
